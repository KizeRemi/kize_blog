...
const CategoryLink = ({ href, label, imageUrl, children }) => (
  <Link href={href}>
    <a style={{ backgroundImage: `url('${imageUrl}')` }} className="block mx-2 lg:mx-auto bg-cover text-sm lg:w-72 h-72 flex flex-col justify-center items-center uppercase tracking-widest opacity-90 col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3">
