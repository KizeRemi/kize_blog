...
const Resume = ({ title, children, imageUrl }) => (
  <div class="flex flex-col items-center my-20 md:text-center bg-white container mx-auto">
    <Title centered as="h2" weight="thin" uppercase>{title}</Title>
    <p className="mt-4 px-2 max-w-4xl text-xl leading-7 text-gray-500 lg:mx-auto">
      {children}
    </p>
